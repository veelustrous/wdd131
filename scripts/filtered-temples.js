...
const temples = [
  ...
  },
 {
    ...
    area: 12000,
    imageUrl:"https://churchofjesuschristtemples.org/assets/img/temples/london-england-temple/london-england-temple-63058-thumb.jpg"
  },
  {
...
// Render an array of temples
function renderTemples(templeArray) {
  container.innerHTML = "";
  templeArray.forEach(renderTemple);
}
